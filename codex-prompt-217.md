...
- [x] Reject unparseable markdown passage ranges before hashing so create-time and scan-time cannot diverge.
- [x] Add drift-scan coverage for the free-text passage range path.
...
- Reject unparseable markdown passage ranges before hashing so create-time and scan-time cannot diverge.

### Suggested Next Task
- Add drift-scan coverage for the free-text passage range path.
